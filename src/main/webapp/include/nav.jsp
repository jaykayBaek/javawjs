	      ...
	      <c:if test="${level != 1}">
		      ...
		      <li class="nav-item dropdown">
		        ...
		        <div class="dropdown-menu">
				      ...
				      <a class="dropdown-item" href="${ctp}/upLoad2.st">멀티파일업로드2</a>
				      <a class="dropdown-item" href="${ctp}/upLoad3.st">멀티파일업로드3</a>
				      <a class="dropdown-item" href="${ctp}/upLoad4.st">멀티파일업로드4</a>
				    </div>
		      </li>
	      </c:if>
	      <li class="nav-item dropdown">
