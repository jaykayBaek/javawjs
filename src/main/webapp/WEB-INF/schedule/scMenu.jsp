    ...
    <table class="table table-hover text-center">
      ...
      <c:forEach var="vo" items="${vos}" varStatus="st">
        <tr>
          <td>${st.count}</td>
          <td>
          	<a href="#" onclick="modalView('${vo.part}','${fn:replace(vo.content,newLine,'<br/>')}')" class="" data-toggle="modal" data-target="#myModal">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     <div class="modal-header">
       <h4 class="modal-title"><b>${ydm}</b></h4>
     ...
     <div class="modal-body">
     	<table class="table">
     		...
     		<tr><th>작성자</th><td><span>${sMid}</span></td></tr>
     	</table>
     </div>
