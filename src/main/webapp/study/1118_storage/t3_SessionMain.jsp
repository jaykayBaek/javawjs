...
<p><br/><p>
	<div class = "container">
		...
		<div class="row mb-3">
			<div class="col"><button class="btn btn-warning form-control">세션 저장</button></div>
		...
		<div class="row mb-3">
			<div class="col"><a href="t3_SessionGroup.jsp" class="btn btn-info form-control">세션 그룹 확인</a></div>
		</div>
	</form>
	</div>
<p><br/><p>
