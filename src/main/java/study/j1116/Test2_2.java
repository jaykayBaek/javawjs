...
public class Test2_2 extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
		...
		// 서버에 get방식으로의 전송방법
		response.sendRedirect(request.getContextPath()+"/study/1116/test2Ok.jsp?name="+name+"&hakbun="+hakbun+"&kor="+kor+"&eng="+eng+"&math="+math+"&sci="+sci+"&soc="+soc+"&tot="+tot+"&avg="+avg+"&grade="+grade);
	}
}
